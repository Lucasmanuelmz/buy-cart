...
export default function Cart() {
  ...
  function handleUpdate(productId) {
    ...
    const productToUpdate = carts.products.find((product) => product.productId === productId);
        ...
        <div className="cart">
          <div className="cart-container">
            ...
            >
              ...
              >
                <tr>
                  <th style={{ border: 'solid #999 0.3px', padding: 10 }} scope="col">
                    Product name
                  </th>
                  <th style={{ border: 'solid #999 0.3px', padding: 10 }} scope="col">
                    Quantity
              ...
              <tbody>
                {carts.products.map((product) => {
                  ...
                  return (
                    <tr style={{ border: 'solid #999 0.3px', padding: 8 }} key={product.productId}>
                      ...
                      <td style={{ border: 'solid #999 0.3px', padding: 8 }}>
                        ...
                        <button style={{padding: 5, 
                          ...
                          color: '#fff', marginLeft: 5}} onClick={() => handleUpdate(product.productId)}>Update</button>
                      </td>
                    </tr>
                  );
                })}
